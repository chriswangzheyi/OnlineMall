<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"  import="com.wzy.utils.*"%>
<%
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a
						href="back/bootm" target="mainframe">
			    ...
			    <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            ...
                            <li><a href="user/list" target="mainframe"> <i
									class="icon-double-angle-right"></i> 用户管理
							</a></li>
                       		<li><a href="goods/loadadd" target="mainframe"> <i
									class="icon-double-angle-right"></i> 商品添加
							</a></li>
								<li><a href="goods/list" target="mainframe"> <i
									class="icon-double-angle-right"></i> 商品查询
							</a></li>
							<li><a href="order/list" target="mainframe"> <i
									class="icon-double-angle-right"></i> 订单查询
							</a></li>
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="back/bootm"
